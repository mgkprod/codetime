<template>
  <div class="w-full">
    <div class="flex flex-col items-start w-full max-w-sm mx-auto mb-8 overflow-hidden bg-white rounded shadow-sm">
      <div class="w-full px-5 py-4 font-semibold bg-gray-50">Sign in to your account</div>
      <form class="w-full" @submit.prevent="submit">
        ...
        <div class="w-full px-5 py-4 text-sm bg-gray-50">
          <div class="flex justify-end">
            <button class="inline-block px-4 py-2 text-sm font-semibold text-white transition duration-200 ease-in-out bg-blue-500 rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-opacity-50 focus:ring-blue-500"><i class="mr-1 fas fa-sign-in-alt"></i> Sign In</button>
          </div>
        </div>
      </form>
    </div>
